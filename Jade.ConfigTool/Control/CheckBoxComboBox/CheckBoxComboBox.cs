...
namespace PresentationControls
{
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
            ...
            : base()
        {
            ...
            ContainerControl.Width = this.Size.Width;
            ContainerControl.Height = 250;
        ...
        public new Size Size
        {
            ...
            {
                base.Size = value;
                DropDownControl.Width = value.Width;
            }
        }
        ...
        public new int Width
        {
            ...
            {
                base.Width = value;
                this._CheckBoxComboBoxListControl.Width = value;
            }
        }
        ...
        public int ColumnCount
        {
            get
            {
                return _CheckBoxComboBoxListControl.ColumnCount;
            }
            set
            {
                _CheckBoxComboBoxListControl.ColumnCount = value;
            }
        }
    ...
    public class CheckBoxComboBoxListControl : ScrollableControl
    {
        ...
        public void SynchroniseControlsWithComboBoxItems()
        {
            ...
            if (NewList.Count > 0)
            {
                ...
                {
                    table.Controls.Add(NewList[i], i % ColumnCount, i / ColumnCount);
                }
